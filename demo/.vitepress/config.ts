...
export default defineConfigWithTheme<ThemeConfig>({
  ...
  vite: {
    ...
    resolve: {
      alias: {
        '@codelume/theme': path.join(__dirname, '../../src')
      }
    }
  },
  ...
  themeConfig: {
    ...
    socialLinks: [
      ...
      { icon: 'douyin', link: 'https://www.douyin.com/user/MS4wLjABAAAAYJwaMc2dOA3HSbCOfuFJZUu8eru187cX0Xrr-YmObNGa4KpmLEwGHDGFDTHhSC-a' }
    ],
